...
fsl5.0-flirt -in dtifitresult_AD -ref nodif_brain -out iso2.0_dtifitresult_AD -applyisoxfm 2
fsl5.0-flirt -in dtifitresult_RD -ref nodif_brain -out iso2.0_dtifitresult_RD -applyisoxfm 2
...
fsl5.0-flirt -in dtifitresult_AD -applyxfm -init normalized_nodif_brain.mat -out normalized_dtifitresult_AD -paddingsize 0.0 -interp trilinear -ref $FILEPATH_MNI152_T1_2mm_brain
fsl5.0-flirt -in dtifitresult_RD -applyxfm -init normalized_nodif_brain.mat -out normalized_dtifitresult_RD -paddingsize 0.0 -interp trilinear -ref $FILEPATH_MNI152_T1_2mm_brain
