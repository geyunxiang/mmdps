...
fsl5.0-flirt -in $FILEPATH_template -applyxfm -init ../inv_normalized_iso2.0_nodif_brain.mat -out "$OUTDIR/wtemplate_2" -paddingsize 0.0 -interp nearestneighbour -ref ../iso2.0_nodif_brain
