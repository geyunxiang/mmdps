...
import subprocess 
from mmdps.util.loadsave import load_nii
...
OUTFOLDER_INTER = 'bold_net_attr_inter_dynamic'
OUTFOLDER_INTRA = 'bold_net_attr_intra_dynamic'

class InterAttrCalcDynamic:
...
class IntraAttrCalcDynamic:
	def __init__(self, niipath, atlasobj, outfolder, json_name):
		...
		self.outfolder = outfolder
		self.exeName = path.fullfile("netcalc_intra_region_dynamic.exe")
		self.from_json(json_name)
